...
export default function Accessories() {
  ...
  useEffect(() => {
    fetch('https://dummyjson.com/products/category/sunglasses') // simulate accessories
      .then((res) => res.json())
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="bg-green-600 text-white py-10 px-6 text-center">
        ...
        <p className="mt-2 text-sm">Complete your look with trendy accessories!</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row px-6 py-10">
        <aside className="w-full md:w-1/4 pr-4">
          ...
          <ul className="text-sm space-y-1">
            <li><input type="checkbox" defaultChecked /> Sunglasses</li>
